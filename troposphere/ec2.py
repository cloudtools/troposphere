...
class NetworkAclEntryPortRange(AWSProperty):
    """
    `NetworkAclEntryPortRange <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-networkaclentry-portrange.html>`__
    """
...
class NetworkAclEntry(AWSObject):
    ...
    props: PropsDictType = {
        ...
        "PortRange": (NetworkAclEntryPortRange, False),
...
class PortRange(AWSProperty):
    """
    `PortRange <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-ec2-verifiedaccessendpoint-portrange.html>`__
    """
