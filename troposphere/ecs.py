...
from .validators import (
    ...
    integer_range, ecs_proxy_type, ecs_efs_encryption_status
)
...
class AuthorizationConfig(AWSProperty):
    """
    AuthorizationConfig for EFSVolumeConfiguration
    """
    props = {
...
class EFSVolumeConfiguration(AWSProperty):
    """
    EFSVolumeConfiguration for Volume for TaskDefinition
    """
    props = {
