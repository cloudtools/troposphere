...
LAUNCH_TYPE_EC2: Final[str] = "EC2"
LAUNCH_TYPE_FARGATE: Final[str] = "FARGATE"

SCHEDULING_STRATEGY_REPLICA: Final[str] = "REPLICA"
SCHEDULING_STRATEGY_DAEMON: Final[str] = "DAEMON"


RUNTIME_PLATFORM_CPU_CONFIGURATIONS: Final[list[str]] = ["ARM64", "X86_64"]
RUNTIME_PLATFORM_OS_FAMILY: Final[list[str]] = [
    "LINUX",
