...
privateSecurityGroup = t.add_resource(ec2.SecurityGroup(
...
redshiftServerlessClusterNamespace = t.add_resource(redshiftserverless.Namespace(
...
redshiftServerlessWorkGroup = t.add_resource(redshiftserverless.Workgroup(
