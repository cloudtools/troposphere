...
from troposphere import Equals, If, NoValue, Output, Parameter, Ref, Template
...
template.set_description(
    "Create two dynamodb tables with "
    "conditional on-demand billing. One "
    "with global secondary index and one without"
)


on_demand = template.add_parameter(
    Parameter(
        "BillOnDemand", Type="String", Default="true", AllowedPattern="(false|true)"
    )
)
