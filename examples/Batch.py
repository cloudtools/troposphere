...
PrivateSubnetB = t.add_parameter(Parameter("PrivateSubnetB", Type="String"))

Vpc = t.add_parameter(
    Parameter(
        "Vpc", ConstraintDescription="Must be a valid VPC ID.", Type="AWS::EC2::VPC::Id"
    )
)
...
BatchComputeEnvironment = t.add_resource(
    ComputeEnvironment(
        ...
        ComputeResources=ComputeResources(
            ...
            Tags=dict(Name="batch-compute-environment", Project="example"),
        ),
    )
)

ExampleJobQueue = t.add_resource(
    JobQueue(
        "ExampleJobQueue",
        ComputeEnvironmentOrder=[
            ComputeEnvironmentOrder(
